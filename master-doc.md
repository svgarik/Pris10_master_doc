## Дизайн ML системы - Автоматизированный мониторинг пользовательских реакций на контен
...
Выбранная инфраструктура:
 ...
 - Kubernetes (EKS/GKE):
     ...
     - Отказоустойчивость (multi-AZ deployment).
...
- Логирование:
     ...
     - Только агрегированные метрики для аналитики.
